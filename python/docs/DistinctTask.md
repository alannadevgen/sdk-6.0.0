...
**params** | **bool, date, datetime, dict, float, int, list, str, none_type** | Parameters of the distinct task. | 
**dependency** | **[str]** | List of all dependencies of the task. | 
**type** | **str** | Type of the distinct task. | [optional]  if omitted the server will use the default value of "distinct"
