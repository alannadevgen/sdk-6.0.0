...
**params** | **bool, date, datetime, dict, float, int, list, str, none_type** | Parameters of the join task. | 
**dependency** | **[str]** | List of all dependencies of the task. | 
**type** | **str** | Type of the join task. | [optional]  if omitted the server will use the default value of "join"
