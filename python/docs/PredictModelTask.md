...
**params** | **bool, date, datetime, dict, float, int, list, str, none_type** | Parameters for the model prediction. | 
**dependency** | **[str]** | List of all dependencies of the task. | 
**type** | **str** | Type of the predict model task. | [optional]  if omitted the server will use the default value of "predict_model"
