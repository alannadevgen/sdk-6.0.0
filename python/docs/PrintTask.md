...
**params** | **bool, date, datetime, dict, float, int, list, str, none_type** | Parameters of the print task. | [optional] 
**type** | **str** | Type of the printtask. | [optional]  if omitted the server will use the default value of "print"
