...
class ActionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.execute_action_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'internal'
    ...
    def execute_action(
        ...
        **kwargs
        ...
        >>> thread = api.execute_action(x_tenant, action, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['action'] = \
            action
        return self.execute_action_endpoint.call_with_http_info(**kwargs)
