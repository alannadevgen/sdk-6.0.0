...
class NotificationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_notifications_endpoint = _Endpoint(
            settings={
                'response_type': ([Notification1],),
                'auth': [
                    'internal'
                ...
                'endpoint_path': '/notifications',
                'operation_id': 'find_notifications',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_notification(
        ...
        **kwargs
        ...
        >>> thread = api.create_notification(notification1, async_req=True)
        >>> result = thread.get()

        Args:
            notification1 (Notification1): The notification to be created
    ...
    def find_notifications(
        ...
        **kwargs
        ...
        >>> thread = api.find_notifications(x_tenant, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['x_tenant'] = \
            x_tenant
        return self.find_notifications_endpoint.call_with_http_info(**kwargs)
