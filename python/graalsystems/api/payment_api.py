...
class PaymentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_payments_endpoint = _Endpoint(
            settings={
    ...
    def find_payments(
        ...
        **kwargs
        ...
        >>> thread = api.find_payments(x_tenant, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['x_tenant'] = \
            x_tenant
        return self.find_payments_endpoint.call_with_http_info(**kwargs)
