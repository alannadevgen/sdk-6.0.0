...
class VerificationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.find_verification_by_code_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/verifications',
                'operation_id': 'find_verification_by_code',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_verification(
        ...
        **kwargs
        ...
        >>> thread = api.create_verification(type, value, async_req=True)
        >>> result = thread.get()
    ...
    def find_verification_by_code(
        ...
        **kwargs
        ...
        >>> thread = api.find_verification_by_code(type, value, code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code'] = \
            code
        return self.find_verification_by_code_endpoint.call_with_http_info(**kwargs)
