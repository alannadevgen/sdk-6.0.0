...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.execute_action  # this is an instance of the class Endpoint
        api_instance.execute_action()  # this invokes api_instance.execute_action.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.execute_action.callable or self.callable in this class
