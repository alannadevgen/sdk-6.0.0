...
def lazy_import():
    ...
    globals()['AggParams'] = AggParams


class AggTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        """AggTask - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of the aggregation task.. [optional] if omitted the server will use the default value of "aggregation"  # noqa: E501
        """
