...
def lazy_import():
    ...
    globals()['AzureConnectorOptions'] = AzureConnectorOptions


class AzureConnector(ModelNormal):
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """AzureConnector - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Connect to an Azure Blob Storage.. [optional] if omitted the server will use the default value of "azure"  # noqa: E501
        """
