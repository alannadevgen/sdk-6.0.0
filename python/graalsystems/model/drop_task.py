...
def lazy_import():
    ...
    globals()['DropParams'] = DropParams


class DropTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        """DropTask - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of the drop task.. [optional] if omitted the server will use the default value of "drop"  # noqa: E501
        """
