...
def lazy_import():
    ...
    globals()['OrderParams'] = OrderParams


class OrderTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            type (str): Type of the order task.. [optional] if omitted the server will use the default value of "order"  # noqa: E501
        """
