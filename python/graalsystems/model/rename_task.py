...
def lazy_import():
    ...
    globals()['RenameParams'] = RenameParams


class RenameTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        """RenameTask - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of the rename task.. [optional] if omitted the server will use the default value of "rename"  # noqa: E501
        """
