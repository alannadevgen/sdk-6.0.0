...
def lazy_import():
    ...
    globals()['S3ConnectorOptions'] = S3ConnectorOptions


class S3Connector(ModelNormal):
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """S3Connector - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Connection to a S3 bucket.. [optional] if omitted the server will use the default value of "s3"  # noqa: E501
        """
