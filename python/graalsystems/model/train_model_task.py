...
def lazy_import():
    ...
    globals()['RandomForest'] = RandomForest


class TrainModelTask(ModelNormal):
    ...
    def _from_openapi_data(cls, id, params, dependency, *args, **kwargs):  # noqa: E501
        """TrainModelTask - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): Type of the train model task.. [optional] if omitted the server will use the default value of "train_model"  # noqa: E501
        """
