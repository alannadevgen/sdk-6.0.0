...
class UserActivityAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, actor, target, verb, *args, **kwargs):  # noqa: E501
        """UserActivityAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, actor, target, verb, *args, **kwargs):  # noqa: E501
        """UserActivityAllOf - a model defined in OpenAPI
